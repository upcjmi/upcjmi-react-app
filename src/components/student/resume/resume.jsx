        ...
        <Row>
          ...
          <div className="pro-details">
            ...
            <div>
              ...
              <Col xs={12} sm={8} md={8}>
                <p contenteditable="true" onKeyUp={e => {this.onInputChange(e.target,'work','company',key)}} className="contenteditableInput resumeInput border size15 " placeholder="Company/Organization Name" >{value.company}</p>
              </Col>
              <Col xs={12} sm={8} md={8}>
                <p contenteditable="true" onKeyUp={e => {this.onInputChange(e.target,'work','location',key)}} className="contenteditableInput resumeInput border size15"   placeholder="Company Location" >{value.companyLocation}</p>
              </Col>
              <Col xs={24} sm={24} md={24} lg={24} xl={24}>
                <p contenteditable="true" onKeyUp={e => {this.onInputChange(e.target,'work','designation',key)}} className="contenteditableInput resumeInput border size15" placeholder="Designation">{value.designation}</p></Col>
              <Col xs={24} sm={24} md={24} lg={24} xl={24}>
