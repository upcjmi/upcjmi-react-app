...
import {basicSignUpTFormCompany} from 'forms/signUp/basic.signUp.tForm';
...
const BasicSignUpCompany: FC<IProps> = ({action, data, next}: IProps) => {
  const form = (
    // @ts-ignore
    <FormCreator
      formTemplate={basicSignUpTFormCompany}
...
export default BasicSignUpCompany;
